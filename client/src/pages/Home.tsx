...
const ASSET_ORIGIN = "https://turkmenai-lxyvv4qu.manus.space/manus-storage";
const assetUrl = (filename: string) => `${ASSET_ORIGIN}/${filename}`;
...
function SignalLogo() { return <img className="brand-mark" src={assetUrl("turkmenai-logo-symbol_d3087e01.png")} alt="TurkmenAI" />; }
...
function DownloadMatrix({ t }: { t: Record<string, string> }) {
  const targets = [
    ...
    { os: t.macos, arch: "Apple Silicon / Intel", packageName: "DMG", status: "planned" },
  ];
